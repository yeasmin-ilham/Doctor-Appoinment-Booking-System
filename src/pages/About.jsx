...
const About = () => {
  return (
    <section className='bg-primary mx-auto px-4'>
      <div className=' pl-6 md:pl-12 lg:pl-20 py-9'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-y-10 md:gap-y-0'>
        ...
        <div>
       <img src={bro} alt="hospital" className=' w-30 h-auto sm:w-45 object-cover'/>
        </div>
        <div className='flex items-center justify-center'>
          <p className='text-[8px] sm:text-[11px] text-white'>We are committed to providing clear, patient-friendly healthcare services with compassion and professionalism.
